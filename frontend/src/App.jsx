    ...
    <div className="app-shell">
      ...
      <main id="explore" className="explorer" tabIndex={-1}>
        ...
        <section className={`results-panel ${mobileView === "list" ? "mobile-active" : ""}`} aria-label="Daftar tempat">
          ...
          <div className="results-body"><RecommendationList /><div className="insight-wrap"><StationInsightPanel /></div><div className="discovery-tip"><Sparkles size={17}/><p>Pilih kartu tempat untuk menyorot lokasinya di peta.</p></div></div>
        </section>
      </main>
